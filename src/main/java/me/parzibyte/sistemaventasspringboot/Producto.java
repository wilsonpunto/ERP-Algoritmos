...
public class Producto {
    ...
    @NotNull(message = "Debes especificar el proveedor")
    @Size(min = 1, max = 50, message = "El proveedor debe medir entre 1 y 50")
    private String proveedor;


    public Producto(String nombre, String codigo, Float precio, Float existencia, Integer id, String proveedor) {
        this.nombre = nombre;
        this.codigo = codigo;
        this.precio = precio;
    ...
    public Producto(String nombre, String codigo, Float precio, Float existencia, String proveedor) {
        this.nombre = nombre;
        this.codigo = codigo;
        this.precio = precio;
        this.existencia = existencia;
